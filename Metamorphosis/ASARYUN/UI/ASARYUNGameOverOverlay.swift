...
struct ASARYUNSurvivalOverlay: View {
...
private struct ASARYUNCriticalVignette: View {
    let isLethal: Bool
...
private struct ASARYUNGameOverOverlay: View {
